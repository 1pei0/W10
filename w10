...
const char* event = "line-pei";  //IFTTT事件名稱
const char* apiKey = "dTiA14NLmSvLca07DTcpN2";  //IFTTT Applet key
const char* host2 = "api.openweathermap.org";
const char* resource = "/data/2.5/weather?id=1668341&appid=994cb2990be1ff88e175ad761feac75c"; 
...
void SendLineNotify(String value1, String value2 , String value3 ){
  ...
  if (client.connect(host1, httpPort)) {
    ...
    //Webhook API
    String url = "/trigger/line_pei/with/key/dTiA14NLmSvLca07DTcpN2";
    //Query String
